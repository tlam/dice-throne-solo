...
function GamePage() {
  ...
  const resolve = (): void => {
    if (gameSession) {
      // Check if there are outcomes available and none is selected
      ...
      setShowAlert(false);
      setSelectedOutcome(""); // Reset selected outcome after resolving
    }
  };
  ...
  return (
    <div className="w-full max-w-[1800px] mx-auto">
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl shadow-2xl p-2 text-white">
        ...
        {showAlert && (
          <Alert 
            message="Please select an outcome option before resolving!"
